package com.sample.leeeyou.customview.demo9.customView;
...
/**
 * start()为入口方法,开启动画1 - 动画2 - 动画3 - 动画4 - 动画1,如此反复
 * <p>
 * 个人理解难点在于:
 * 1、canvas的rotate造成x,y轴方向的改变
 * 2、线段长度以及起始位置的计算和圆圈中心点的定位
 */
public class SlackLoadingView extends View {
    ...
    //Canvas起始旋转角度
    private final int CANVAS_ROTATE_ANGLE = 30;
    //动画当前状态
