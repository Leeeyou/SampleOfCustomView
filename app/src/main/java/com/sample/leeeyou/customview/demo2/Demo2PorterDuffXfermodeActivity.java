...
import com.sample.leeeyou.customview.demo2.view.PorterDuffView;

public class Demo2PorterDuffXfermodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo2_porter_duff_xfermode);
        setTitle("图像混合模式");

        mPorterDuff = findViewById(R.id.porterDuffView);
        mTv = findViewById(R.id.tv_desc);
    }
